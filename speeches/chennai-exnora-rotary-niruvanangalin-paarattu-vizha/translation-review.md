...
1. **PDF318 / printed p.317 — unsupported interpretive gloss removed**  
   E1: `not one that could then be welcomed as feasible`  
   Corrected: **`not one that could be welcomed`**  
   Reason: frozen Tamil says `வரவேற்க முடியாத திட்டம்`; `as feasible` was an added interpretation.

2. **PDF325 / printed p.324 — added metaphor removed**  
   E1: `a son of this soil`  
   Corrected: **`I, who belong to this soil`**  
   Reason: restores `இந்த மண்ணுக்குச் சொந்தக்காரனான நான்` without adding a familial metaphor.

3. **PDF326 / printed p.325 — source-sensitive place-name transliteration**  
   E1: `Omandur Ramasamy Reddiar`  
   Corrected: **`Omaandur Ramasamy Reddiar`** for frozen Tamil `ஓமாந்தூர்`.

4. **PDF327 / printed p.326 — repeated place-name transliteration**  
   Second occurrence corrected to **`Omaandur Ramasamy Reddiar`**.

5. **PDF327 / printed p.326 — source honorific restored**  
   E1 omitted `அன்னை`.  
   Corrected to **`Prime Minister Annai Indira Gandhi`**.

6. **PDF329 / printed p.328 — source classification restored**  
   E1: `these three waterways`  
   Corrected: **`these three rivers`**  
   Reason: frozen Tamil explicitly says `இந்த மூன்று ஆறுகளையும்`, even though one named feature is the Buckingham Canal.

## E2 verification result

- pages checked: **16/16**, PDF **315–330** / printed **314–329**;
- confirmed corrections: **6**;
- unresolved English issues: **0**;
- missing / duplicate English page records: **0 / 0**;
- page correspondence and recorded joins: **PASS**;
