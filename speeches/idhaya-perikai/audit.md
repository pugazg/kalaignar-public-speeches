...
**Body scope:** PDF pages 4–35, corresponding to printed pages 3–34
...
- PDF 20 / printed 19: the indented classical quotation beginning `கொங்கணர் கலிங்கர் கொடுங்கருநாடர்` has been transcribed from the visible print without using an outside edition to regularize its unusual forms. Every line must be rechecked during T2.
- PDF 21 / printed 20: the unusual first-pass reading `எச்சு ஒருபுறம் - எண்ணம் - ஒருபுறம்` is retained from the scan and must be checked character-by-character during T2 rather than silently normalized.
