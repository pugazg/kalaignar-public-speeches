...
Each English page was checked independently against the frozen Tamil for omitted or added meaning, reversals, softened or strengthened rhetoric, lost repetition, subjects/pronouns/names/titles, silently normalized difficult Tamil, page-boundary loss or duplication, and translator/source notes that overstate what the Tamil establishes. Pages without a fidelity issue were recorded as passes rather than rewritten for style.

## E2 batch summary

| E2 batch | PDF pages | Printed pages | Status | Confirmed corrections |
|---|---:|---:|---|---:|
| 1 | 4–8 | 3–7 | reviewed / passed | 0 |
| 2 | 9–13 | 8–12 | reviewed / consolidated | 6 |
| 3 | 14–18 | 13–17 | reviewed / consolidated | 2 |
| 4 | 19–23 | 18–22 | reviewed / consolidated | 4 |
...
3. **PDF 12 — `திருக்கல்யாணக் குணங்கள்`:** changed “the Lord’s auspicious wedding virtues” to **“the Lord’s auspicious qualities.”**
4. **PDF 12 — `அம்மாமித் தமிழ்` note:** removed the unsupported characterization “a socially marked expression”; the note now states only that the source term is retained rather than neutralized.
5. **PDF 13 — `பல்லாயிரவர்`:** changed “tens of thousands gather” to **“many thousands gather.”**
6. **PDF 13 — `லட்சம்பேர்`:** changed “hundreds of thousands gather” to **“a hundred thousand gather.”**
7. **PDF 16 — `பொறுமையை அடக்கமுடியாத`:** replaced the smooth inference “cannot hold themselves back” with **“cannot restrain their ‘patience’”** and added a source note exposing the difficult verified Tamil rather than substituting another word.
8. **PDF 18 — `அடிப்படையான வெறுப்பே அதுதான்`:** restored the polemical force as **“That is the fundamental basis of our hatred.”**
9. **PDF 20 — classical quotation:** restored the actual unresolved source line **`கடமலை வேட்டமென் கட்டபுலம்பிரியாது`** inside the quotation and explicitly marked it untranslated because its syntax remains unresolved in this edition. No outside edition was substituted.
10. **PDF 22 — `மடத்தனத்தை அழித்தது. மக்கள் சமுதாயத்தை...`:** retained the broad English sequence but added a source note stating that the English regularizes only the difficult syntax and does not amend the frozen Tamil.
11. **PDF 22 — `மட்டமானது`:** changed “even more degraded than ours” to **“even more inferior than ours.”**
12. **PDF 23 — difficult reform wording:** removed editorial commentary from the translated body, which now reads **“Reform moved forward. Superstitions went into a corner and sat there veiled.”** The existing note on `சீர்திருத்தம் முன்னவிட்டது` / `சீர்திருத்த கிடந்த` remains.
13. **PDF 24 — `கோலாகலமாக இருக்கும்`:** changed “will be music to us” to **“will be a celebration for us.”**
14. **PDF 27 — `ஜாமீன் வழக்குத்தொடுத்தது`:** replaced the inferred legal gloss “institute security proceedings” with the source-facing **“file a bail case against him.”**
15. **PDF 28 — `பலாத்கார பேச்சுக்கள்`:** changed “Speeches advocating violence” to **“Violent speeches.”**
16. **PDF 31 — `பிணக்குவியல்கள்`:** removed the added “near-”; the English now says **“heaps of corpses.”**
17. **PDF 31 — `வகுப்புவாரி உரிமை`:** replaced the historically interpretive “communal rights” with the source-facing **“class-wise rights.”**
18. **PDF 34 — `ஆயிரக் கணக்கில்`:** changed “thousands upon thousands of stories” to **“stories in the thousands.”**
19. **PDF 35 — `குருதியிலே மிதக்கவிட்டிருக்கிறது`:** corrected the meaning reversal from “trampled in blood” to **“floating in blood.”**
