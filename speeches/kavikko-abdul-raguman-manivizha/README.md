...
- Constituent range: PDF **228–246** / printed **227–245** — **19 pages**
...
- the closing note directly establishes date **19-07-1998**, event `கவிக்கோ அப்துல் ரகுமான் மணிவிழா`, and role `ஆற்றிய உரை`;
...
**Tamil T1 for constituent 21 — 19 source pages total.** Preserve exact page boundaries and keep the separate closing note outside the speech body. Stop before T2 / constituent 22.
