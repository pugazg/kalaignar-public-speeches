...
- 425 scans; source PDF remains uncommitted
- stable relation: PDF scan = printed page + 1
...
## Constituent 27 — durable Tamil T3 / frozen-Tamil result

Tamil T3: **PASS / COMPLETE — 16/16 source pages; 0 additional corrections; 0 unresolved**. All **6/6** T2 corrections remain consolidated. Superseded canonical speech-body readings are absent. Canonical page records are complete, unique and ordered; page joins, names, numerals, punctuation, quotations, repetitions, applause/laughter markers, Tamil poem, Exnora wordplay, source-sensitive readings, chronology/numeral forms, title variants and the separate closing note pass. No speech-body Tamil changed during T3.

Tamil for constituent 27 is now **`verified-complete` / FROZEN**. English E1 is **READY / NOT STARTED** and must translate only from frozen `transcription-ta.md`.
...
## Constituent 29 — durable source gate

`சென்னை - தியாகிகள் மணிமண்டபத் திறப்புவிழா`  
Directory: `speeches/chennai-thiyagigal-manimandapa-thirappuvizha/`
...
## Constituent 29 — durable English E1 result
...
- **31**: **PASS / COMPLETE — 8/8; 3 corrections; 0 unresolved**. Corrections: PDF366 `அதிகே` → `அதிலே`; PDF367 `பகுத்தறிவு வாதிகள்` → `பகுத்தறிவுவாதிகள்`; PDF368 `காண்றில் வேணும்` → `தானறிதல் வேணும்`. All 7 joins: **PASS**.
- **32**: **PASS / COMPLETE — 19/19; 3 corrections; 0 unresolved**. Corrections: PDF383 `நடித்து தமிழகமெங்கும்` → `நடித்துத் தமிழகமெங்கும்`; PDF386 `நானே வரிகளில்` → `நான்கே வரிகளில்`; PDF390 restored printed `திருமணத்திற்கு` / `திருணமத்திற்கு` contrast. All 18 joins: **PASS**.
- Canonical records for both constituents remain complete / unique / ordered.
- Separate closing notes remain outside speech bodies.
- Constituent 32 embedded poem lineation and title/spacing variants remain preserved.
...
## Constituent 32 — durable Tamil / English / closure result
...
- Source range / page order / all **18** joins / embedded poems / literary-historical references / applause markers / printed typo contrast / title variants / separate closing note: **PASS**.
- Repository closure: **PASS / COMPLETE — FULLY ARCHIVED**.
- Closure speech-body changes: Tamil **0**, English **0**.
- Source PDF remains uncommitted.
