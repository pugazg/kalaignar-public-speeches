...
| Split | Original scans represented | Pages | Bytes | SHA-256 | State |
|---|---:|---:|---:|---|---|
...
## Front-matter physical map

- scan 1 — front cover;
- scan 2 — half-title, `முத்துக் குளியல் / பாகம் - I`;
- scan 3 — price / publication-number / first-edition / rights / printer imprint;
- scan 4 — title page;
- scan 5 — `நூல் அளவை` bibliographic / production details;
- scan 6 — decorative title page;
- scan 7 — blank / reverse;
- scan 8 — `முன்னுரை`;
- scan 9 — reverse / blank;
- scan 10 — `பதிப்புரை`, opening;
- scan 11 — `பதிப்புரை`, continuation, printed p.10;
...
All **61 constituent ranges are now source-verified and closed**. For items 1–60, contents-derived ranges were verified against direct scan boundaries. Item 61 terminates at printed p.639 / PDF640; PDF641 is the verified back cover.
...
| 61 | ஆதித்தனார் பிறந்தநாள் விழா | 28-09-1997 | 629 | **629–639 VERIFIED / CLOSED** | **630–640 VERIFIED / CLOSED** |
...
- constituent source gates: **61/61 COMPLETE**;
- Tamil verified: **61/61**;
- English verified: **61/61**;
- fully archived: **61/61 — FINAL-CLOSED**;
...
- C61 `ஆதித்தனார் பிறந்தநாள் விழா`: PDF630–640 / printed629–639 — **CLOSED / FULLY ARCHIVED**; page joins **10/10 PASS**; cross-split **636→637 PASS**; Tamil T2 **0 corrections / 0 unresolved**; source closing note **முரசொலி 28.9.97**; **PDF641 back cover VERIFIED**;
- collection final closure — **PASS / COMPLETE — 61/61 source-gated, Tamil verified, English verified and fully archived; 0 unresolved**.

## Current next gate

**None. `முத்துக் குளியல் — பாகம் I` is FINAL-CLOSED.** See `FINAL_CLOSURE.md`.
